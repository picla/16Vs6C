...
save(lemnaSlim.poly, file = "Results/Growth/poly3_logRosette_NO_allReps_V3_corCAR1_expFixed.rda")

# residuals
pdf('Results/Growth/Plots/poly3_logRosette_NO_allReps_resiudals_V3_corCAR1_expFixed.pdf')
plot(lemnaSlim.poly)
dev.off()

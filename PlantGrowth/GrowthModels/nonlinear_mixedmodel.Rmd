...
fm2.logis.lis <- nlsList(Area ~ SSlogis(DAS_decimal, Asym, xmid, scal)| ID, data = lemna.sub.grp.conv.df, control = ctrl)

fm2.logis.nlme <- nlme(fm2.logis.lis, fixed = list(xmid ~temperature * acn, Asym ~ temperature * acn, scal ~ temeprature * acn))
plot(fm2.logis.nlme)

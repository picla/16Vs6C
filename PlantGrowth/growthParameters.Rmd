...
# predict
predictData$logArea <- as_tibble(predict(baseModel, newdata = predictData))
...
getSlope.ind.corr <- function(ID, DASs, growth)
{
  ...
  growth.ind$DAS14 <- growth$emmean[growth$ID == ID & growth$DAS == 14]
